...
public class PostTransactionController {
  ...
  public Object updatePostTransaction() {
    ...
    for (String string : postJobs) {
      servProvider.updateQuery(string,null);
    }
  ...
  public Object updateIsCommercialAccount() {
    List<Object> list = servProvider.executeQuery("getAccount", null);
  ...
  public Object updateIsInvoiceAndIsCredit() {
    List<Object> list = servProvider.executeQuery("getTrxPostKeyFlagsForDocTypeAB", null);
    int rowCount = list.size();
    for (int i = 0; i < rowCount; i++) {
        ...
        this.servProvider.updateQuery("updateIsInvoiceAndIsCredit",args);
    }
      return 0;
  }
  ...
  @ResponseBody
  public Object test() {
    Iterator<Object> mQueryResults = servProvider.executeQueryItr("getAllCustomer", null);
    asyncService.execute(mQueryResults, "updateTest", 10, 100);
      return 0;
  }
